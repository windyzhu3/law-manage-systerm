...
public class TodoQueryService
{
    ...
    private String action(String status){return switch(status==null?"":status){case "CREATED"->"CLAIM";case "CLAIMED"->"START";case "IN_PROGRESS","RETURNED"->"SUBMIT";case "SUBMITTED"->"COMPLETE";default->"VIEW";};}
