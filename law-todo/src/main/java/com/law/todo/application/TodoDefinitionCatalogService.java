...
public class TodoDefinitionCatalogService
{
    ...
    public List<ValidatorCatalogEntry> validators(){return validators.stream().map(validator->new ValidatorCatalogEntry(validator.catalogCode(),validator.getClass().getName(),validator.catalogDescription())).sorted(Comparator.comparing(ValidatorCatalogEntry::code)).toList();}
    ...
    public record ValidatorCatalogEntry(String code,String implementation,String description) { }
}
