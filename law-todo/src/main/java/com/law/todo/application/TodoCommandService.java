...
public class TodoCommandService
{
    ...
    @Transactional public TodoInstance returnTodo(Long id,ActionCommand c,Actor a){if(repeated(c))return mapper.selectById(id);TodoInstance t=require(id);if(!access.canReview(t,a.userId()))deny();return transition(t,TodoStatus.RETURNED,null,"RETURN",c,a);}
