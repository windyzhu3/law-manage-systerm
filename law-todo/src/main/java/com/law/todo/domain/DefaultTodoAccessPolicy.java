...
public class DefaultTodoAccessPolicy implements TodoAccessPolicy
{
    ...
    public boolean canView(TodoInstance todo,Long userId,Long deptId){return canOperate(todo,userId)||(deptId!=null&&deptId.equals(todo.getOwnerDeptId()))||canClaim(todo,userId,deptId)||mapper.countCcAccess(todo.getTodoId(),userId)>0;}
}
