...
class TodoExtensionServiceTest
{
    ...
    {
        when(mapper.selectExtensionByActionId("request-1")).thenReturn(null);
    ...
    {
        when(mapper.selectExtensionByActionId("approve-1")).thenReturn(null);
        when(mapper.selectExtensionById(31L)).thenReturn(extension(PENDING,null,null));
    ...
    {
        when(mapper.selectExtensionByActionId("approve-1")).thenReturn(extension(APPROVED,REQUESTED,"approve-1"));
    ...
    {
        when(mapper.selectExtensionByActionId("reject-1")).thenReturn(null);
    ...
    @Test void requestRejectsNonPositiveProofIdsAndConfiguredMaximum()
    {
        ...
        when(mapper.selectExtensionByActionId("too-long")).thenReturn(null);
        when(mapper.selectExtensionContext(9L)).thenReturn(context());
    ...
    @Test void approvalRechecksRequestedDueAgainstCurrentEffectiveDue()
    {
        ...
        when(mapper.selectExtensionByActionId("approve-late")).thenReturn(null);
    ...
    @Test void zeroConfiguredExtensionCountDisablesNormalExtensions()
    {
        ...
        when(mapper.selectExtensionByActionId("disabled")).thenReturn(null);
