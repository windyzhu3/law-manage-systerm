...
class TodoConfigurationSimulationServiceTest
{
    ...
    @Test void simulationIsReadOnlyAndPersistsOnlySanitizedOrderedAudit()
    {
        ...
        verify(businessObjects).requireSimulationBusinessObject("LEAD",3L,actor());
    }
    ...
    @Test void missingBusinessObjectStopsSimulationAndIsAudited()
    {
        ...
        org.mockito.Mockito.when(businessObjects.requireSimulationBusinessObject("LEAD",3L,actor())).thenThrow(missing);
