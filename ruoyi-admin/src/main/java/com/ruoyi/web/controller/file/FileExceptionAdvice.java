...
public class FileExceptionAdvice
{
    ...
    {
        int status=error instanceof FileAccessDeniedException?HttpStatus.FORBIDDEN
            :error instanceof FileUploadUnavailableException?HttpStatus.NOT_FOUND:HttpStatus.ERROR;
