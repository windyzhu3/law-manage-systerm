...
public class TodoTemplateController
{
    ...
    @PreAuthorize("@ss.hasPermi('todo:definition:edit')") @PostMapping("/trigger") public AjaxResult saveTrigger(@Valid @RequestBody TriggerCommand value){return AjaxResult.success(service.saveTrigger(value,actor()));}
    @PreAuthorize("@ss.hasPermi('todo:definition:edit')") @PutMapping("/trigger") public AjaxResult updateTrigger(@Valid @RequestBody TriggerCommand value){return AjaxResult.success(service.saveTrigger(value,actor()));}
