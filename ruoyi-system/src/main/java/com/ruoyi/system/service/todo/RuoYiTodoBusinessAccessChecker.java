...
@Component
public class RuoYiTodoBusinessAccessChecker implements TodoBusinessAccessChecker
{
    ...
    private final BizLeadMapper leads;private final BizContractMapper contracts;private final BizCaseMapper cases;private final BizMatterMapper matters;

    public RuoYiTodoBusinessAccessChecker(BizLeadMapper leads,BizContractMapper contracts,BizCaseMapper cases,BizMatterMapper matters)
    {this.leads=leads;this.contracts=contracts;this.cases=cases;this.matters=matters;}

    @Override public boolean supports(String type){return "LEAD".equals(type)||"CONTRACT".equals(type)||"CASE".equals(type)||"MATTER".equals(type);}
