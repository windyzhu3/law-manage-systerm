...
class ContractPaymentServiceTest
{
    ...
    private Map<String,Object> plan(String status,int due,int paid){Map<String,Object> p=new HashMap<>();p.put("contract_id",2L);p.put("contractStatus","3");p.put("confirm_status",status);p.put("invoice_status","0");p.put("receivable_amount",BigDecimal.valueOf(due));p.put("received_amount",BigDecimal.valueOf(paid));return p;}
}
