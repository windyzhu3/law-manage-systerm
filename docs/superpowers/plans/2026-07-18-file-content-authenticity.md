...
- [x] **Step 3: Implement the enum and pure policy**
...
- [x] **Step 1: Write failing signature and container tests**
...
- [x] **Step 1: Write failing registration, transport and cleanup tests**
...
- [x] **Step 3: Implement minimal pipeline integration**
...
- [x] **Step 4: Run GREEN and the law-file suite**
...
- [x] **Step 2: Run the E2E evidence against disposable MySQL 8.4**
...
- [x] **Step 3: Complete E2E fixtures and evidence text**
...
- [x] **Step 3: Query live admission truth**
...
- [x] **Step 4: Update report and plan from fresh evidence**
