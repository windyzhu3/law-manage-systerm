...
- [x] **Step 4: Extend the real migration invariant**
...
- [x] **Step 5: Run the contract GREEN**
...
- [x] **Step 3: Implement the live SQL read model**
...
- [x] **Step 4: Implement deterministic requirement evaluation**
...
- [x] **Step 3: Implement commands and mapper**
...
- [x] **Step 4: Implement state and independence rules**
...
- [x] **Step 1: Add failing approval and permission tests**
...
- [x] **Step 3: Implement controllers and guard**
...
- [x] **Step 1: Add failing frontend contract and E2E assertions**
...
- [x] **Step 3: Implement API and components**
...
- [x] **Step 4: Verify GREEN and production compilation**
...
- [x] **Step 1: Initialize a fresh MySQL 8 container from the exact CI baseline**
...
- [x] **Step 2: Query baseline truth directly**
...
- [x] **Step 3: Run final full verification**
...
- [x] **Step 4: Update the admission report**
