...
- [x] **Step 2: 运行并确认因新Mapper签名不存在而失败**
...
- [x] **Step 1: 写 Bean Validation 失败测试**
...
- [x] **Step 4: 移除临时转换适配器并直接注入CustomerCommandService**
