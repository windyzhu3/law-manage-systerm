...
for (const required of [
  ...
  'assertGuidedRouteTarget(fixture, route.value, route.label, route.targetCode, expectedVersion)',
...
for (const required of [
  ...
  'assertGuidedDodDropdownLabels',
  'assertGuidedRouteUi',
  'metadata.dodFields',
  'metadata.dodMaterials',
  'metadata.routes',
  'metadata.rawCodes',
  "value: 'MISJUDGED_VALID', label: '误判有效'",
  "value: 'CONNECTED', label: '联系成功'",
  "value: 'PROGRESS_RECORDED', label: '已记录实质进展'",
  "not.toContainText(new RegExp(metadata.rawCodes.join('|')))",
