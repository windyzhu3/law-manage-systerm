...
const routes = [
  ...
  ['getTodoTemplateJourney', '/todo/config/templates/${id}/journey', 'get'],
  ['listTodoTemplateWorkbench', '/todo/config/templates/workbench', 'get'],
  ['hydrateTodoJourneyPayload', '/todo/config/templates/${id}/journey/payload', 'post'],
  ['simulateTodoJourney', '/todo/config/templates/${id}/journey/simulate', 'post'],
...
function checkTemplatePage() {
  ...
  requireTokens(page, contents[page], ['templateNavigationTarget', 'target.view'])
  assertMethodTokens(page, contents[page], 'openJourney', ['templateId:', 'todo-template-journey', "view === 'published'"])
