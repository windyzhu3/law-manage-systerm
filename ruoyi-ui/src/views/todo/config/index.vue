...
import FoundationAdmissionOverview from './components/FoundationAdmissionOverview'
...
export default {
  name: 'TodoConfig', components: { TemplateList, VersionDrawer, TriggerRuleTable, WorkCalendarTable, DecisionRegistry, AdmissionEvidenceRegistry, FoundationAdmissionOverview, FoundationResourceReadiness, HistoricalMigrationReadiness, FileSecurityReadiness, FinanceReadiness, AcceptanceReadiness },
