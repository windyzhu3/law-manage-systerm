  ...
  <div class="biz-page finance-page" :class="'biz-size-' + appSize">
    ...
    >
      ...
      <el-table v-else v-loading="loading" :data="list" :size="controlSize">
        ...
        <el-table-column label="操作" width="110" align="center" class-name="small-padding fixed-width biz-operation-column" fixed="right">
          <template slot-scope="{ row }"><el-button v-hasPermi="['finance:expense:edit']" :size="controlSize" type="text" @click="openExpense(row)">处理</el-button></template>
        </el-table-column>
      </el-table>
    </biz-table-card>
