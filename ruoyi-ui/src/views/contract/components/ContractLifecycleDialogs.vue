<template>
  ...
  <div slot="footer"><el-button :size="controlSize" @click="$emit('update:approvalOpen', false)">取消</el-button><el-button :size="controlSize" type="primary" @click="saveApproval">提交</el-button></div>
  </el-dialog>
  ...
  <div slot="footer"><el-button :size="controlSize" @click="$emit('update:signOpen', false)">取消</el-button><el-button :size="controlSize" type="primary" :disabled="!signForm.signStatus" @click="saveSign">确定</el-button></div>
  </el-dialog>
  ...
  <div slot="footer"><el-button :size="controlSize" @click="$emit('update:invoiceOpen', false)">取消</el-button><el-button :size="controlSize" type="primary" :disabled="!invoiceForm.invoiceStatus" @click="saveInvoice">确定</el-button></div>
  </div>
</template>
<script>
export default {
